...
layout = [[psg.Text('1. katman:'), psg.DropDown(['Bisküvi', 'Krema'], key='katman1'), psg.Text('2. katman:'), psg.DropDown(['Bisküvi', 'Krema'], key='katman2'), psg.Text('3. katman:'), psg.DropDown(['Bisküvi', 'Krema'], key='katman3')],
...
main_window = psg.Window('Oreo Generator', layout, size=(500,700), grab_anywhere=True, no_titlebar=False)
...
while True:
    ...
    if event == 'Oluştur':
        main_window['img1'].update(filename=None)
        main_window['img2'].update(filename=None)
        main_window['img3'].update(filename=None)
        main_window['img4'].update(filename=None)
        main_window['img5'].update(filename=None)
        main_window['img6'].update(filename=None)
        main_window['img7'].update(filename=None)
        main_window['img8'].update(filename=None)
        main_window['img9'].update(filename=None)
        event = 'empty'
